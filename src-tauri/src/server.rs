...
fn api_routes() -> Router {
    Router::new()
        ...
        .route("/weight/:id", delete(handlers::delete_weight).put(handlers::update_weight))
        .route("/meditation", get(handlers::list_meditations).post(handlers::create_meditation))
        .route("/meditation/:id", delete(handlers::delete_meditation).put(handlers::update_meditation))
        .route("/feelings", get(handlers::list_feelings).post(handlers::create_feeling))
        .route("/feelings/:id", delete(handlers::delete_feeling).put(handlers::update_feeling))
